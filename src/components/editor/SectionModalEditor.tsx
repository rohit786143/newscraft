...
export const SectionModalEditor: React.FC<SectionModalEditorProps> = ({
  ...
  const handleZoomOut = () => {
    setZoomScale((prev) => Math.max(0.3, Math.round((prev - 0.1) * 10) / 10));
  };
        ...
        <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
                        ...
                        const col1Photo = (localSection.image && targetCol1 === 1) ? (
                          ...
                          >
                            <img
                              ...
                              style={{ width: '100%', height: `${h1Val}px`, maxHeight: `${h1Val}px`, objectFit: (localSection.imageFit as any) || 'cover', display: 'block' }}
                            />
                            {localSection.caption && (
                              <div
                                ...
                                style={{ textAlign: (localSection.captionAlign as any) || 'left', height: '14px', lineHeight: '14px' }}
                              >
                                {localSection.caption}
                              </div>
                            )}
                        ...
                        const col2Photo = (hasCol2Photo && img2Src && effectiveCols >= 2) ? (
                          ...
                          >
                            <img
                              ...
                              alt="Photo 2"
                              className="w-full object-cover border border-black p-0.5 block"
                              style={{ width: '100%', height: `${h2Val}px`, maxHeight: `${h2Val}px`, objectFit: (fit2Val as any) || 'cover', display: 'block' }}
                            />
                            {cap2Text && (
                              <div
                                className="text-[9.5px] italic text-slate-700 pt-0.5 truncate whitespace-nowrap overflow-hidden text-ellipsis block max-w-full"
                        ...
                        const col3Photo = (hasCol3Photo && img3Src && effectiveCols >= 3) ? (
                          ...
                          >
                            <img
                              ...
                              alt="Photo 3"
                              className="w-full object-cover border border-black p-0.5 block"
                              style={{ width: '100%', height: `${h3Val}px`, maxHeight: `${h3Val}px`, objectFit: (fit3Val as any) || 'cover', display: 'block' }}
                            />
                            {cap3Text && (
                              <div
                                className="text-[9.5px] italic text-slate-700 pt-0.5 truncate whitespace-nowrap overflow-hidden text-ellipsis block max-w-full"
          ...
          <div className="w-full md:w-[440px] lg:w-[480px] shrink-0 bg-slate-900 border-t md:border-t-0 md:border-l border-slate-800 flex flex-col h-full overflow-hidden shadow-2xl">
            ...
            <div className="flex-1 overflow-y-auto p-4 custom-scrollbar">
              ...
              {/* 5. PHOTO & CAPTION TOOLBAR (PER-COLUMN TOP PHOTO CONTROLS) */}
              {activeTarget === 'image' && (
                <div className="space-y-4 text-slate-100 text-xs select-none">
                  <div className="flex items-center justify-between pb-2 border-b border-slate-800">
                    <span className="font-bold text-blue-400 text-xs flex items-center gap-1.5">
                      <i className="fa-solid fa-image text-blue-400"></i> फ़ोटो, लेआउट व कॉलम सेटिंग्स
                    </span>
                    <div className="flex items-center gap-1.5">
                      <input
                        type="file"
                        ...
                        {[1, 2, 3].map((cNum) => {
                          ...
                          return (
                            <button
                              ...
                              type="button"
                              onClick={() => {
                                updateField('imageCol', cNum as any);
                                updateField('layout', `col${cNum}-top` as any);
                              }}

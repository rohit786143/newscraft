...
function distributeBalancedColumns(content, numCols, photoHeights, colWidth = 210, fontOptions = {}) {
  ...
  function renderTokensHTML(tokens, isCol1) {
  ...
  function measureHeight(tokens, isCol1) {
                        ...
                        const col1Photo = (localSection.image && targetCol1 === 1) ? (
                          ...
                          >
                            <img
                              ...
                              style={{ maxHeight: `${h1Val}px`, objectFit: localSection.imageFit || 'cover' }}
                            />
